...
<div class="container-fluid d-flex justify-content-end navbar2">
	...
	<div class="topm_Details  ">
		<div class="  displays innertop_Details ">
			<div class="displaycos ">
				<div class="innerbox_Details">productID:${dto3.lssoo}</div>
				<div class=""><img src="${pageContext.request.contextPath}/resources/salpic/${dto3.lssoo}.jpg" class="img-fluid img_Details"></div>
			</div>
			<div class="innerbox3_Details col-5 ">
				<div class="displays">
					 <h5><span class="badge text-bg-secondary "> ${dto3.laddress2} </span></h5>
					 <h5><span class="badge text-bg-secondary"> 대형견 환영,고양이 , 강아지 </span></h5>
					 <h5><span class="badge text-bg-secondary"> ${dto3.lshuemoo}  </span></h5>
				</div>	 
					<hr>
			<div class="boxtop text_Details">[미용 예약] ${dto3.lsname} </div>		     
			 <div class="text_Details sejong_nav" style="margin-top:20px">진료 분야: <span class="text_Details">${dto3.lsarea}</span></div>
				<div class="displays " >					   
					<div class="detailbox2_Details">											
						<div class="text2_Details sejong_nav">영업 시간:  <span  class="text3_Details">${dto3.lstime}</span></div>	
						<div class="text2_Details sejong_nav" > 전화 번호: <span class="text3_Details">${dto3.lstel}</span></div>
						
						<div class="displays" style="width:600px;" >				
   							<div class="text2_Details sejong_nav " >가게 주소: <span class="text3_Details" >${dto3.lsaddress}</span></div>
   						 </div>
						<div class="displays" style="width:600px;">
					...
					<div class=" displays  detailbox3_Details  ">				
							<form name="form2" id="form2" method="post" action="Bookingconfirm.do" onsubmit="return validateForm()">
   							<input type="hidden" name="rname" value="${dto3.lsname}">
            				<input type="hidden" name="rtel" value="${dto3.lstel}">
            				<input type="hidden" name="raddress" value="${dto3.lsaddress}">
            				<input type="hidden" name="rsoo" value="${dto3.lssoo}">
    ...
    <a class="swiper-slide swiperbox" href="${pageContext.request.contextPath}/detailsalon.do?lsname=미라클펫살롱"><img src="./resources/salpic/S001.jpg" width="350" height="280"></a>
      <a  class="swiper-slide swiperbox"  href="${pageContext.request.contextPath}/detailsalon.do?lsname=프롬코코"><img src="./resources/salpic/S002.jpg" width="350" height="280"></a>
      <a class="swiper-slide swiperbox "  href="${pageContext.request.contextPath}/detailsalon.do?lsname=청담아이윌동물병원"><img src="./resources/salpic/S003.jpg" width="350" height="280"></a>
 <a class="swiper-slide swiperbox "  href="${pageContext.request.contextPath}/detailsalon.do?lsname=오드리애견미용실"><img src="./resources/salpic/S004.jpg" width="350" height="280"></a>
  <a class="swiper-slide swiperbox "  href="${pageContext.request.contextPath}/detailsalon.do?lsname=곰스살롱"><img src="./resources/salpic/S005.jpg" width="350" height="280"></a>
...
<br class="br mt-4 ">	
	 ...
	 <div class="lowm_Details">
	<div class="m-4 text_Details do_nav"> 📍 ${dto3.lsname} 위치 보기 </div>
	...
	<div id="map" style="width:100%;height:550px;"> 
     ...
     mapOption = { 
         center: new kakao.maps.LatLng(${dto3.lsxdo}, ${dto3.lsydo}), // 지도의 중심좌표
         level: 3 // 지도의 확대 레벨
     };
 ...
 // 마커를 표시할 위치입니다 
 var position =  new kakao.maps.LatLng(${dto3.lsxdo}, ${dto3.lsydo});
 ...
 var iwContent = '<div style="padding:5px;"> [예약 방문지]</div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
