...
<div class="container-fluid d-flex justify-content-end navbar2">
	...
	<div  class="jua_nav Title_orderDetails ">📝  Booking Details</div>	
	 ...
	 <div class="displaycos">
	 	<div class=" textcolor_orderDetails sejong_nav"> 주문 번호 : ${BookListVO.rorder} </div>	
	 	<hr class="line_orderDetails">
	 </div>	
	<div class="displayc box_OrderDetails ">
	<div class=" displayb box_OrderDetails2 ">	
		  <div class="textcolor_orderDetails sejong_nav" style="color:gray;"> 주문자 : ${BookListVO.email} </div>		 
	 	<form action="deleteBooking.do" class="mr-4" style="margin-right:20px;">
	 	    <input type="hidden" class="conDbox"  name ="rorder" value="${BookListVO.rorder}">
	 	    <input type="hidden" class="conDbox"  name ="email" value="${BookListVO.email}">
	 		<input type="submit" class="box_OrderDetails3" value="예약취소">
	 	</form>
         </div>	 
	  ...
	  <div class="margin2_OrderDetails ">
	    <div class="text_orderDetails sejong_nav"> <span style="font-weight:bold;"> [병원] </span>${BookListVO.rname} </div>
	    <div style="margin-bottom:8px;"> 매장 전화번호 : ${BookListVO.rpet} </div>
	     <div style="margin-bottom:8px;"> 반려동물 이름 : ${BookListVO.rtel} </div>
	  	 <div style="margin-bottom:8px;"> 매장 위치: ${BookListVO.raddress}   </div>	  	
	  	  <div style="margin-bottom:8px;"> 방문 견종 : ${BookListVO.rcate} </div>	
	   </div>
	   <div>
	   <img src="./resources/picService/H1.jpg" class="photo_orderdetails">	  
	   </div>  
	   </div>    
	  </div>
	   <hr class="line2_orderDetails">
	  ...
	  <div class="text2_orderDetails do_nav">  <img src="${pageContext.request.contextPath}/resources/pic/mypage.png" width="30px" height="30px"> 예약 내역 확인 </div>
	  <hr class="line2_orderDetails">
	  <div class="displays box_OrderDetails4 ">
	  
	  <div class="margin2_OrderDetails">
	  
	   	<div >방문 예정일 : ${BookListVO.rdate}</div>
	  	<div> 방문 보호자 성함 : ${BookListVO.rperson}</div>
	  	<div> 보호자 전화번호  ${BookListVO.rpet} </div>
	  	<div> 반료 동물 이름 :  ${BookListVO.rtel} </div>
