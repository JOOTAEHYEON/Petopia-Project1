...
<div class="container-fluid d-flex justify-content-end navbar2">
	...
	<div class="topm_Details  ">
		<div class="  displays innertop_Details ">
			<div class="displaycos ">
				<div class="innerbox_Details">productID:${dto.htsoo}</div>
				<div class=""><img src="${pageContext.request.contextPath}/resources/hotpic/${dto.htsoo}.jpg" class="img-fluid img_Details"></div>
			</div>
			<div class="innerbox3_Details col-5 ">
				<div class="displays">
					 <h5><span class="badge text-bg-secondary "> ${dto.htaddress2} </span></h5>
					 <h5><span class="badge text-bg-secondary"> 대형견 환영,고양이 , 강아지 </span></h5>
					 
				</div>	 
					<hr>
			<div class="boxtop text_Details">[동물 호텔 예약] ${dto.htname} </div>		     
			 <div class="text_Details sejong_nav" style="margin-top:20px">진료 분야: <span class="text_Details">${dto.htarea}</span></div>
				<div class="displays " >					   
					<div class="detailbox2_Details">											
						<div class="text2_Details sejong_nav">${dto.httime}</div>	
						<div class="text2_Details sejong_nav" > 전화 번호: <span class="text3_Details">${dto.httel}</span></div>
						
						<div class="displays" style="width:600px;" >				
   							<div class="text2_Details sejong_nav " >가게 주소: <span class="text3_Details" >${dto.htaddress}</span></div>
   						 </div>
						<div class="displays" style="width:600px;">
					...
					<div class=" displays  detailbox3_Details  ">				
							<form name="form2" id="form2" method="post" action="Bookingconfirm.do" onsubmit="return validateForm()">
   							<input type="hidden" name="rname" value="${dto.htname}">
            				<input type="hidden" name="rtel" value="${dto.httel}">
            				<input type="hidden" name="raddress" value="${dto.htaddress}">
            				<input type="hidden" name="rsoo" value="${dto.htsoo}">          				
    ...
    <a class="swiper-slide swiperbox" href="${pageContext.request.contextPath}/detailsalon.do?lsname=미라클펫살롱"><img src="./resources/hotpic/HT001.jpg" width="350" height="280"></a>
      <a  class="swiper-slide swiperbox"  href="${pageContext.request.contextPath}/detailsalon.do?lsname=프롬코코"><img src="./resources/hotpic/HT149.jpg" width="350" height="280"></a>
      <a class="swiper-slide swiperbox "  href="${pageContext.request.contextPath}/detailsalon.do?lsname=청담아이윌동물병원"><img src="./resources/hotpic/HT048.jpg" width="350" height="280"></a>
 <a class="swiper-slide swiperbox "  href="${pageContext.request.contextPath}/detailsalon.do?lsname=오드리애견미용실"><img src="./resources/hotpic/HT011.jpg" width="350" height="280"></a>
  <a class="swiper-slide swiperbox "  href="${pageContext.request.contextPath}/detailsalon.do?lsname=곰스살롱"><img src="./resources/hotpic/HT075.jpg" width="350" height="280"></a>
...
<br class="br mt-4 ">	
	 ...
	 <div class="lowm_Details">
	<div class="m-4 text_Details do_nav"> 📍 ${dto.htname} 위치 보기 </div>
	...
	<div id="map" style="width:100%;height:550px;"> 
     ...
     <script>
         ...
         mapOption = { 
             center: new kakao.maps.LatLng(${dto.htxdo}, ${dto.htydo}), // 지도의 중심좌표
             level: 3 // 지도의 확대 레벨
         };
         ...
         //마커가 표시될 위치입니다 
         var markerPosition  = new kakao.maps.LatLng(${dto.htxdo}, ${dto.htydo}); 
         ...
         iwPosition = new kakao.maps.LatLng(${dto.htxdo}, ${dto.htydo}); //인포윈도우 표시 위치입니다
